...
class GeneralLedgerController extends Controller
{
    ...
    public function general_ledger_report(Request $request){
        if(Auth::user()){
            ...
            $endDate = $request->input('end_date'); // "2025-05-04"
            ...
            if($agentSupplier === 'agent'){
                ...
                foreach ($sortedCollection as $index => $item) {
                    ...
                    if ($item->table_name == "tickets") {
                        ...
                        if (is_null($item->supplier) && $item->who === 'agent_' . $agentSupplierId) {
                            ...
                            if($item->reissued_new_ticket == 1){
                                $html .= <<<HTML
                                    <tr>
                                        <td class="w-[10%]">$item->invoice<br><b><small style="COLOR: blue;">$item->invoice_date</small><b></td>
                                ...
                                $html .= <<<HTML
                                    <tr>
                                        ...
                                        <td class="w-[11%]">$item->flight_date</td>
                                        <td class="w-[28%] pr-3">
                                                <small>  <b>PAX NAME:</b> <span class=""> $item->passenger </span><br>
                                                  <b>PNR:</b>  $item->pnr ,<b> Sector:</b>  $item->sector <br>
                                                  $item->airline_code -  $item->airline_name <br>
                                                  <b>Remarks:</b>  $item->remark </small>
                                        </td>
                                        <td class="w-[12%] totaldebit"></td>
                                        <td class="w-[12%] totalcredit">$item->supplier_price</td>
                                        <td class="w-[12%] totaltotal">$currentAmount</td>
                    ...
                    elseif ($item->table_name == "receive") {
                        ...
                        $html .= <<<HTML
                        <tr>
                            <td class="w-[10%]">$item->invoice  <br><small style="COLOR: blue;">$item->date</small></td>
                            <td class="w-[15%]">  </td>
                            <td class="w-[11%]"> </td>
                            <td class="w-[28%] pr-3">
                                <small><b>Remarks:</b> {$item->remark} <br>
                               
                                <b>Received by:</b> {$methodDisplay}</small>
                            </td>
                            <td class="w-[12%] totaldebit"></td>
                        ...
                        $html .= <<<HTML
                                                 ...
                                                 <td class="w-[15%]">  </td>
                                                    ...
                                                    <td class="w-[28%] pr-3" >
                                                        <small><b>Remarks:</b>  {$item->remark} <br>
                                                        <b>Payment by:</b> {$activeTransactionMethods[$item->method]}<small>
                                                    </td>
                        ...
                        if ($ticket) {
                            $html .= <<<HTML
                                ...
                                <td class="w-[28%] pr-3">
                                    <small><b>Reissue to Customer:</b> $agentname,  
                                    {$item->invoice}<br> <b>Ticket No:</b> {$ticket->airline_code}/{$ticket->ticket_no}, <br>
                                    <b>Sector:</b> {$ticket->sector},<br> on {$item->date} <b> PAX Name: {$ticket->passenger}</b><small>
                                </td>
                            HTML;
                        } else {
                        ...
                        if ($ticket) {
                            $html .= <<<HTML
                                <tr>
                                <td class="w-[10%]"> $ticket->invoice<br><small style="color:blue;"> $item->date</small></td>
                                <td class="w-[15%]"> {$ticket->ticket_code}-{$ticket->ticket_no}  </td>
                                    <td class="w-[11%]"> {$ticket->flight_date} </td>
                                    <td class="w-[28%] pr-3">
                                        <small>
                                        <b>Refund to Customer :</b>  $agentname ,  
                                        {$ticket->invoice}<br> <b>Ticket No :</b> {$ticket->airline_code}/{$ticket->ticket_no}, <br>
                                        <b>Sector :</b> {$ticket->sector} ,<br> on {$item->date} <b> PAX Name : {$ticket->passenger}</b></small>
                                    </td>
                                    <td class="w-[12%] totaldebit"></td>
                            ...
                            $html .= <<<HTML
                                <tr>
                                    ...
                                    <td class="w-[28%]">
                                        <!-- Remarks: Refund -->
                                        <b>Refund to Customer : $agentname <br>
                                        on {$item->date}</b>
                                    </td>
                                    <td class="w-[12%] totaldebit"></td>
                                    <td class="w-[12%] totalcredit">{$item->now_agent_fere}</td>
                        ...
                        if (is_null($item->supplier) && $item->who === 'agent_' . $agentSupplierId) {
                            ...
                            $html .= <<<HTML
                                                ...
                                                <td class="w-[15%]"> {$typeneme} </td>
                                                    <td class="w-[11%]">  </td>
                                                    <td class="w-[28%] pr-3"><small>
                                                        <b>Passenger:</b> {$item->name} <br>
                                                        <b>Passport:</b> {$item->passport_no}<br>
                                                        <b>Remarks:</b>  {$item->remark}</small>
                                                    </td>
                                                    <td class="w-[12%] totaldebit"></td>
                        ...
                        $balance += $item->now_agent_fare;
                        $currentAmount = $balance >= 0 ? $balance . ' DR' : $balance . ' CR';
                        $debit += $item->now_agent_fare;
                        ...
                        if ($ticket) {
                            $html .= <<<HTML
                                 <tr >
                                                    ...
                                                    <td class="w-[11%]"> {$ticket->flight_date} </td>
                                                    <td class="w-[28%] pr-3"><small>
                                                        <b>Void to Customer :</b> $agentname ,  
                                                        <br> <b>Ticket No :</b> {$ticket->airline_code}/{$ticket->ticket_no}, <br>
                                                        <b>Sector :</b>{$ticket->sector} ,<br> on {$item->date} <b> PAX Name : {$ticket->passenger}</b>
                                                        <b>Remarks</b>:  {$ticket->remark}</small>
                                                    </td>
                                                    <td class="w-[12%] totaldebit">{$item->now_agent_fare}</td>
                                                    <td class="w-[12%] totalcredit"></td>
                                                    <td class="w-[12%] totaltotal">{$currentAmount}</td>
                                                </tr>
                            HTML;
                    ...
                    //     $html .= <<<HTML
                    //         <tr class="hover:bg-gray-300 cursor-pointer" onclick="toggleDetails('{$detailsId}')" id="contract-details">
                    //             <td class="w-[10%] py-2">
                    //                 <div class="">{$item->contract_data->invoice}</div>
                    //                 <div class="text-xs text-gray-600" style="color:blue;">{$item->date}</div>
                    //             </td>
                    //             <td class="w-[11%]">
                    ...
                    //                                 <th class="text-left py-2 px-2 w-1/4">Date</th>
                    //                                 <th class="text-left py-2 px-2 w-1/4">Service</th>
                    //                                 <th class="text-left py-2 px-2 w-1/4">Flight</th>
                    //                                 <th class="text-left py-2 px-2 w-2/4">Service Output</th>
                    //                                 <th class="text-right py-2 px-2 w-1/4">Price</th>
                    //                             </tr>
                    //                         </thead>
                    //                         <tbody>
                    //     HTML;
                    ...
                    //                     <td class="py-1 px-2">{$service->note}</td>
                    //                     <td class="py-1 px-2 text-right">
                    //                         <div class="flex items-center justify-end">
                    //                             <span class="price-value hidden">{$service->allocated_amount}</span>
                    //                             <button class="eye-toggle ml-2 text-gray-500 hover:text-gray-700 focus:outline-none" onclick="togglePriceVisibility(this, event)">
                    ...
                    //                 $details = "Visa No: {$extra->wakala_visa_no}, ID NO: {$extra->wakala_id_no}";
                    //             } else {
                    //                 $date = $extra->ticket_invoice_date;
                    //                 $note = $extra->ticket_note;
                    //                 $details = "Airline: {$extra->ticket_airline},Sector: {$extra->ticket_sector}<br>Passenger: {$extra->ticket_passenger_name}";
                    //             }
                    
                    //             $html .= <<<HTML
                    //                 <tr class="border-b border-gray-200">
                    //                     <td class="py-1 px-2">{$date}</td>
                    //                     <td class="py-1 px-2">{$extraName}<br>Ticket No:{$extra->ticket_number}</td>
                    //                     <td class="py-1 px-2">Flight: {$extra->ticket_travel_date}</td>
                    //                     <td class="py-1 px-2">
                    //                         {$details}
                    //                         <div class="text-xs text-gray-500">Remarks: {$note}</div>
                    //                     </td>
                    //                     <td class="py-1 px-2 text-right">
                    //                         <div class="flex items-center justify-end">
                    //                             <span class="price-value hidden">{$extra->amount}</span>
                    //                             <button class="eye-toggle ml-2 text-gray-500 hover:text-gray-700 focus:outline-none" onclick="togglePriceVisibility(this, event)">
                    //                                 <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    //                                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    //                                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                    ...
                    elseif ($item->table_name == "contract") {
                        ...
                        $html .= <<<HTML
                            <tr class="hover:bg-gray-200 border-b border-gray-300 cursor-pointer" onclick="toggleDetails('{$detailsId}')">
                                <td class="py-2 px-3">
                                    <div class="font-semibold text-sm">{$item->contract_data->invoice}</div>
                                    <div class="text-xs text-blue-600">{$item->date}</div>
                                </td>
                                <td class="py-2 px-3">
                                    <div class="text-sm font-semibold">Contract</div>
                                    <div class="text-xs text-gray-600">Passport: {$item->contract_data->passport_no}</div>
                                </td>
                                <td class="py-2 px-3">
                                    <div class="text-sm font-medium">{$item->contract_data->name}</div>
                                    <div class="text-xs text-gray-600">{$item->contract_data->country}</div>
                                </td>
                                <td class="py-2 px-3 text-sm truncate" title="{$item->contract_data->notes}">
                                    {$item->contract_data->notes}
                                </td>
                                <td class="py-2 px-3 text-left font-medium">{$item->contract_data->total_amount}</td>
                                <td class="py-2 px-3"></td>
                                <td class="py-2 px-3 text-left font-semibold">{$currentAmount}</td>
                            </tr>
                                        ...
                                        <table class="w-full text-sm border-collapse">
                                            <thead>
                                                <tr class="bg-gray-100 text-gray-700">
                                                    ...
                                                    <th class="py-2 px-2 text-left">Service</th>
                                                    <th class="py-2 px-2 text-left">Flight/Sales By</th>
                                                    <th class="py-2 px-2 text-left">Service Output</th>
                        ...
                        if (!empty($item->services)) {
                            foreach ($item->services as $service) {
                                ...
                                $html .= <<<HTML
                                    <tr class="border-b border-gray-200">
                                        <td class="py-2 px-2">{$service->date}</td>
                                        <td class="py-2 px-2">{$serviceName}</td>
                                        <td class="py-2 px-2"></td>
                                        <td class="py-2 px-2">{$service->note}</td>
                                        <td class="py-2 px-2 text-right">
                                            <div class="flex items-center justify-start">
                                                <button class="eye-toggle ml-2 text-gray-500 hover:text-gray-700" onclick="togglePriceVisibility(this, event)" title="Toggle Amount">
                        ...
                        if (!empty($item->extra_types)) {
                            foreach ($item->extra_types as $extra) {
                                $extraName = ucfirst($extra->extratype) ?? 'Extra';
                                if ($extra->extratype == 'wakala') {
                                    $date = $extra->wakala_date;
                                    $note = $extra->wakala_note;
                                    $flight_sales_by = 'Sales By: '.$extra->wakala_sales_by;
                                    $details = "Visa No: {$extra->wakala_visa_no}, ID NO: {$extra->wakala_id_no}";
                                } else {
                                    $date = $extra->ticket_invoice_date;
                                    $note = $extra->ticket_note;
                                    $flight_sales_by = 'Flight Date: '.$extra->ticket_travel_date;
                                    $details = "Airline: {$extra->ticket_airline}, Sector: {$extra->ticket_sector}<br>Passenger: {$extra->ticket_passenger_name}";
                                }
                                ...
                                $html .= <<<HTML
                                    <tr class="border-b border-gray-200">
                                        ...
                                        <td class="py-2 px-2">{$extraName}<br><span class="text-xs text-gray-500">Ticket No: {$extra->ticket_number}</span></td>
                                        <td class="py-2 px-2">{$flight_sales_by}</td>
                                        <td class="py-2 px-2">
                                            <div>{$details}</div>
                                            <div class="text-xs text-gray-500">Remarks: {$note}</div>
                                        </td>
                ...
                foreach ($sortedCollection as $index => $item) {
                            ...
                            if($item->reissued_new_ticket == 1){
                                $html .= <<<HTML
                                    <tr>
                                        ...
                                        <td class="w-[12%] totaldebit">$item->supplier_price</td>
                                        <td class="w-[12%] totalcredit"></td>
                                        <td class="w-[12%] totaltotal">$currentAmount</td>
                                    </tr>
                                HTML;
                            ...
                            if($item->reissued_new_ticket == 1){
                                $html .= <<<HTML
                                    <tr>
                                        ...
                                        <td class="w-[12%] totaldebit"></td>
                                        <td class="w-[12%] totalcredit">$item->agent_price</td>
                                        <td class="w-[12%] totaltotal">$currentAmount</td>
                                    </tr>
                                HTML;
                            }
                        ...
                        if ($ticket) {
                            $html .= <<<HTML
                              ...
                              <td class="w-[28%]">
                                ...
                                Sector :{$ticket->sector} ,<br> on {$item->date} <b> PAX Name : {$ticket->passenger}</b><br/></small>
                              </td>
                        HTML;
                        } else {
                            $html .= <<<HTML
                        ...
                        if (is_null($item->supplier) && $item->who === 'agent_' . $agentSupplierId) {
                            ...
                            $html .= <<<HTML
                                                ...
                                                <td class="w-[15%]"> {$typeneme} </td>
                                                    ...
                                                    <td class="w-[12%] totaldebit">{$item->payable_amount}</td>
                                                    <td class="w-[12%] totalcredit"></td>
                                                    <td class="w-[12%] totaltotal">{$currentAmount}</td>
                                                </tr>
                                HTML;
                            ...
                            $html .= <<<HTML
                                                <tr>
                                                    ...
                                                    <td class="w-[12%] totaldebit"></td>
                                                    <td class="w-[12%] totalcredit">{$item->contact_amount}</td>
                                                    <td class="w-[12%] totaltotal">{$currentAmount}</td>
                                                </tr>
                                                HTML;
                        }
                    ...
                    elseif ($item->table_name == "contract") {
                        ...
                        $html .= <<<HTML
                              <tr id="{$detailsId}" class="bg-gray-50">
                                <td colspan="7" class="px-4 py-3">
                                    <div class="overflow-x-auto">
                                        <table class="w-full text-sm border-collapse">
                                            <thead>
                                    ...
                                    <tr class="border-b border-gray-200">
                                        ...
                                        <td class="py-2 px-2 text-right">
                                            <div class="flex items-center justify-start">
                                                ...
                                                <span class="price-value totalcredit">{$service->allocated_amount}</span>
                                    ...
                                    <tr class="border-b border-gray-200">
                                        ...
                                        <td class="py-2 px-2 text-left">
                                            <div class="flex items-center justify-start">
                                                ...
                                                <span class="price-value totalcredit">{$extra->amount}</span>
