<x-app-layout>
    ...
    <div class="main-content" id="main-content">
        ...
        <div class="content">
            ...
            <h3 class="text-lg font-semibold text-gray-800 mb-4">Weekly Report</h3>
            <div class="grid gap-5 lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1">
                ...
                <div class="bg-white p-5 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                    <div class="flex justify-between items-start mb-3">
                        <div>
                            <p class="text-gray-500 text-sm font-medium">Pending Tickets</p>
                            <h2 class="text-blue-600 text-2xl font-bold mt-1">{{ array_sum($pending_ticket_counts) }}
                            </h2>
                        </div>
                    ...
                    <canvas id="paindingTicketChart" height="100"></canvas>
                </div>

                <!-- Weekly Sales Ticket Card -->
                <div class="bg-white p-5 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                    <div class="flex justify-between items-start mb-3">
                        <div>
                            <p class="text-gray-500 text-sm font-medium">Weekly Ticket Sales</p>
                            <h2 class="text-green-600 text-2xl font-bold mt-1">{{ $total_today_sales_ticket }}</h2>
                        </div>
                ...
                <!-- Weekly Wakala Sales Card -->
                <div class="bg-white p-5 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                    <div class="flex justify-between items-start mb-3">
                        <div>
                            <p class="text-gray-500 text-sm font-medium">Weekly Wakala</p>
                            <h2 class="text-purple-600 text-2xl font-bold mt-1">{{ array_sum($pending_wakala_counts) }}
                            </h2>
                        </div>
                    ...
                    <canvas id="wakalaSalesChart" height="100"></canvas>
                </div>

                <!-- Weekly Visa Sales Card -->
                <div class="bg-white p-5 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                    <div class="flex justify-between items-start mb-3">
                        <div>
                            <p class="text-gray-500 text-sm font-medium">Weekly Visa Sales</p>
                            <h2 class="text-orange-600 text-2xl font-bold mt-1">{{ array_sum($pending_visa_counts) }}
                            </h2>
                        </div>
                    ...
                    <canvas id="visaSalesChart" height="100"></canvas>
                </div>

            </div>

            <h3 class="text-lg font-semibold text-gray-800 my-4">Transaction Overview</h3>
            <div class="grid gap-5 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 mt-2">
                ...
                <div class="card shadow-sm h-100 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 bg-orange-300">
            ...
            <div class="grid gap-5 lg:grid-cols-2 md:grid-cols-1 mt-2">

                <div class="card shadow-sm h-100 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 bg-indigo-400">
                        <div class="flex items-center justify-between">
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                @foreach ($closetickets as $ticket)
                                                    <tr class="hover:bg-gray-50">
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                            {{ $ticket->airline_name }}/{{ $ticket->airline_code }}
                                                        </td>
                                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                            {{ $ticket->passenger }}</td>
                                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            ...
                            <table class="my-5 text-sm text-black border table table-hover">
                                <thead>
                                    <tr class="border-b bg-[#7CB0B2]">
                                        <th class="w-6/12 px-4 py-1 text-left text-gray-700 font-medium">Bank
                                        </th>
                                        <th class="w-4/12 px-4 py-1 text-left text-gray-700 font-medium">
                                            Description
                                        </th>
                                        <th class="w-2/12 px-4 py-1 text-left text-gray-700 font-medium">Amount
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                ...
                                <tfoot>
                                    ...
                                    <tr class="border-b hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-2 text-gray-700 text-md font-semibold">
                                            {{ $total_amount }}
                                        </td>
                                    </tr>
                                </tfoot>
                        ...
                        <table class="  my-5 text-sm text-black border table table-hover">
                            <thead>
                                <tr class="border-b bg-[#7CB0B2]">
                                    ...
                                    <th class="w-1/6 px-4 py-1 text-left text-gray-700 font-medium">Invoice
                                        Number</th>
                                    ...
                                    <th class="w-1/6 px-4 py-1 text-left text-gray-700 font-medium">Remarks
                                    </th>
                        ...
                        <div class="container mx-auto py-6">
                            <div class="grid md:grid-cols-2 sm:grid-cols-1 text-center border-gray-300">
                                ...
                                <div
                                    ...
                                    <h2 class="text-teal-600 text-4xl font-extrabold">
                                        {{ $total_month_sales_ticket }}
                                    </h2>
                                ...
                                <div
                                    class="flex h-[170px] flex-col items-center border-b justify-center border-gray-300">
                                    <h2 class="text-red-500 text-4xl font-extrabold">
                                        {{ $total_today_sales_ticket }}
                                    </h2>
                                ...
                                <!-- 25+ Programmes -->
                                <div
                                    class="flex h-[170px] flex-col items-center border-r justify-center border-gray-300">
                                    <h2 class="text-orange-500 text-4xl font-extrabold">
                                        {{ $total_month_sales_visa }}
                                    </h2>
                                ...
                                <div class="flex h-[170px] flex-col items-center justify-center">
                                    <h2 class="text-purple-600 text-4xl font-extrabold">
                                        {{ $total_today_sales_visa }}
                                    </h2>
    ...
    <script>
        const data = {
            tickets: @json($pending_ticket_counts),
            orders: @json($pending_visa_counts),
            today_ticket_sale: {{ $total_today_sales_ticket }},
            wakala: @json($pending_wakala_counts),
            day_labels: @json($day_labels),
        };
        // console.log(data);

        new Chart(document.getElementById('paindingTicketChart'), {
            type: 'line',
            data: {
                labels: data.day_labels,
                datasets: [{
                    label: 'Painding Ticket',
                    data: data.tickets,
        ...
        new Chart(document.getElementById('ticketSalesChart'), {
            type: 'line', // or 'bar' for daily comparison
            data: {
        ...
        new Chart(document.getElementById('wakalaSalesChart'), {
            type: 'line',
            data: {
                labels: data.day_labels,
                datasets: [{
        ...
        new Chart(document.getElementById('visaSalesChart'), {
            type: 'line',
            data: {
                labels: data.day_labels,
                datasets: [{
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
                        ...
                        callbacks: {
                            label: function(context) {
                                ...
                                if (context.chart.config.type === 'pie' || context.chart.config.type ===
                                    ...
                                    return `${label}: ${formatCurrency(value)} (${percentage}%) - ${count} transactions`;
                                }
                                return `${label}: ${formatCurrency(value)} - ${count} transactions`;
                            }
                        }
                    }
                },
            ...
            document.getElementById('total_receive').innerHTML = `Total: ${formatCurrency(totalReceiveAmount)}`;
