    ...
    <div class="main-content" id="main-content">
        <div class="content">
            @if (in_array('entry', $permissionsArray))
                <form autocomplete="off" action="{{ route('submit.payment') }}" id="submit_form_receive" method="post">
                    @csrf
                    <div class="flex justify-between">
                        ...
                        <div class="flex justify-between">
                            ...
                            <input type="text" style="padding: 0%; border: none;" id="receiveRef" name="paymentRef"
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="receiveDate" name="paymentDate" required/>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="from_account" required name="paymentMethod" onchange="showRemainingBalance(this, 'from')">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select id="clientName" required name="supplierName">
                                <option value="" selected>Select one</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="receiveAmount" name="paymentAmount" required placeholder="Enter amount" />
