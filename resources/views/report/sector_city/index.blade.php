                ...
                <form autocomplete="off" id="reportForm" action="{{ route('sector_city_report') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                        ...
                        <div class="flex flex-col gap-1">
                            <label for="start_date" class="font-medium text-sm text-gray-700">Start From</label>
                            <div class="">
                                <select id="start_from" name="start_from"
                                    class="select2 text-gray-900 text-sm bg-gray-50 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 block w-full p-1"
                                    required>
                        ...
                        <div class="flex flex-col gap-1">
                            <label for="start_date" class="font-medium text-sm text-gray-700">End To</label>
                            <div class="">
                                <select id="end_to" name="end_to"
                                    class="select2 text-gray-900 text-sm bg-gray-50 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 block w-full p-1"
                                    required>
                                    <option value="">Select City</option>
